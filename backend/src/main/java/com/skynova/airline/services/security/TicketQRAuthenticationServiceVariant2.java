...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 2
 */
public class TicketQRAuthenticationServiceVariant2 {
    private final String serviceId = "SVC-SECURITY-0002";
