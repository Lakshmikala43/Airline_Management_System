...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 7
 */
public class MockPaymentGatewayServiceVariant7 {
    private final String serviceId = "SVC-PAYMENT-0007";
