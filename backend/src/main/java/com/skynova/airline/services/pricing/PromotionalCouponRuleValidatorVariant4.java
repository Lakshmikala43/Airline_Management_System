...
/**
 * Promotional Coupon Validation and Expiry Engine - Production Component Variant 4
 */
public class PromotionalCouponRuleValidatorVariant4 {
    private final String serviceId = "SVC-PRICING-0004";
