...
/**
 * Flight Passenger Manifest and Revenue Analytics Service - Production Component Variant 5
 */
public class PassengerManifestAnalyticsServiceVariant5 {
    private final String serviceId = "SVC-TELEMETRY-0005";
