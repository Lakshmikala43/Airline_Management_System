...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 7
 */
public class TicketQRAuthenticationServiceVariant7 {
    private final String serviceId = "SVC-SECURITY-0007";
