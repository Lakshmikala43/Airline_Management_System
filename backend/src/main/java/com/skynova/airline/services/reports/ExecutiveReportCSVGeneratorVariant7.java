...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 7
 */
public class ExecutiveReportCSVGeneratorVariant7 {
    private final String serviceId = "SVC-REPORTS-0007";
