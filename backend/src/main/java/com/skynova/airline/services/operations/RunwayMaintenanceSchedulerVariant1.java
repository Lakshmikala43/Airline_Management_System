...
/**
 * Runway Availability and Maintenance Operational Scheduler - Production Component Variant 1
 */
public class RunwayMaintenanceSchedulerVariant1 {
    private final String serviceId = "SVC-OPERATIONS-0001";
