...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 7
 */
public class CustomerLoyaltyTierCalculatorVariant7 {
    private final String serviceId = "SVC-LOYALTY-0007";
