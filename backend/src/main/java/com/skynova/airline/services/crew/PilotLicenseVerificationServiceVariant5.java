...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 5
 */
public class PilotLicenseVerificationServiceVariant5 {
    private final String serviceId = "SVC-CREW-0005";
