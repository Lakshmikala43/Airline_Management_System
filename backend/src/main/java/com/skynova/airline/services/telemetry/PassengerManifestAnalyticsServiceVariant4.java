...
/**
 * Flight Passenger Manifest and Revenue Analytics Service - Production Component Variant 4
 */
public class PassengerManifestAnalyticsServiceVariant4 {
    private final String serviceId = "SVC-TELEMETRY-0004";
