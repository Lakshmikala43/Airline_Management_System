...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 1
 */
public class InFlightMealFulfillmentServiceVariant1 {
    private final String serviceId = "SVC-CATERING-0001";
