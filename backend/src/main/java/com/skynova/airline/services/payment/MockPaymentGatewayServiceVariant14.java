...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 14
 */
public class MockPaymentGatewayServiceVariant14 {
    private final String serviceId = "SVC-PAYMENT-0014";
