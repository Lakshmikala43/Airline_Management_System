...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 6
 */
public class TicketQRAuthenticationServiceVariant6 {
    private final String serviceId = "SVC-SECURITY-0006";
