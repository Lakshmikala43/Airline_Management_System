package com.skynova.airline.services.passenger;
...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 13
 */
public class PassportExpiryIdentityValidatorVariant13 {
    private final String serviceId = "SVC-PASSENGER-0013";
