...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 2
 */
public class ExecutiveReportCSVGeneratorVariant2 {
    private final String serviceId = "SVC-REPORTS-0002";
