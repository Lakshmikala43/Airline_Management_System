...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 2
 */
public class InFlightMealFulfillmentServiceVariant2 {
    private final String serviceId = "SVC-CATERING-0002";
