...
/**
 * Promotional Coupon Validation and Expiry Engine - Production Component Variant 14
 */
public class PromotionalCouponRuleValidatorVariant14 {
    private final String serviceId = "SVC-PRICING-0014";
