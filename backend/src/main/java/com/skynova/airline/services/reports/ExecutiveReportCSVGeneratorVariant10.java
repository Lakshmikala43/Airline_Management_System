...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 10
 */
public class ExecutiveReportCSVGeneratorVariant10 {
    private final String serviceId = "SVC-REPORTS-0010";
