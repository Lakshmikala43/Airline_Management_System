...
/**
 * Lost Luggage Claim Investigation and Compensation Processor - Production Component Variant 3
 */
public class LostLuggageClaimInvestigatorVariant3 {
    private final String serviceId = "SVC-BAGGAGE-0003";
