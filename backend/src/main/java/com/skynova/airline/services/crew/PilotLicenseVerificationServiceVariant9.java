...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 9
 */
public class PilotLicenseVerificationServiceVariant9 {
    private final String serviceId = "SVC-CREW-0009";
