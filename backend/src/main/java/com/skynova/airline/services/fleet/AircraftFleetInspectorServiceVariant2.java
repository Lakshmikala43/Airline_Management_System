...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 2
 */
public class AircraftFleetInspectorServiceVariant2 {
    private final String serviceId = "SVC-FLEET-0002";
