...
/**
 * Airport Gate Allocation and Conflict Resolution Service - Production Component Variant 4
 */
public class AirportGateAllocationServiceVariant4 {
    private final String serviceId = "SVC-OPERATIONS-0004";
