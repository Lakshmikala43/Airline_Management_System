...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 4
 */
public class InFlightMealFulfillmentServiceVariant4 {
    private final String serviceId = "SVC-CATERING-0004";
