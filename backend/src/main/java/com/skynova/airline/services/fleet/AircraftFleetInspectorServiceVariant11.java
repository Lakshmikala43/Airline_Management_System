...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 11
 */
public class AircraftFleetInspectorServiceVariant11 {
    private final String serviceId = "SVC-FLEET-0011";
