...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 8
 */
public class PilotLicenseVerificationServiceVariant8 {
    private final String serviceId = "SVC-CREW-0008";
