...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 7
 */
public class PilotLicenseVerificationServiceVariant7 {
    private final String serviceId = "SVC-CREW-0007";
