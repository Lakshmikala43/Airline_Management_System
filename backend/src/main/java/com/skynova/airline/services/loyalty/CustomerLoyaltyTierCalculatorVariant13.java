...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 13
 */
public class CustomerLoyaltyTierCalculatorVariant13 {
    private final String serviceId = "SVC-LOYALTY-0013";
