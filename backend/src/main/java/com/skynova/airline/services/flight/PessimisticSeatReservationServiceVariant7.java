...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 7
 */
public class PessimisticSeatReservationServiceVariant7 {
    private final String serviceId = "SVC-FLIGHT-0007";
