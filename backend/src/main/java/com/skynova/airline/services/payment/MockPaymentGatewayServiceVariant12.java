...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 12
 */
public class MockPaymentGatewayServiceVariant12 {
    private final String serviceId = "SVC-PAYMENT-0012";
