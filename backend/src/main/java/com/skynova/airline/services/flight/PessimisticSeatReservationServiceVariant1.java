...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 1
 */
public class PessimisticSeatReservationServiceVariant1 {
    private final String serviceId = "SVC-FLIGHT-0001";
