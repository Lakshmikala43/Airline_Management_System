...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 14
 */
public class AircraftFleetInspectorServiceVariant14 {
    private final String serviceId = "SVC-FLEET-0014";
