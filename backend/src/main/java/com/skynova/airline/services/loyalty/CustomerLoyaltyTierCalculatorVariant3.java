...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 3
 */
public class CustomerLoyaltyTierCalculatorVariant3 {
    private final String serviceId = "SVC-LOYALTY-0003";
