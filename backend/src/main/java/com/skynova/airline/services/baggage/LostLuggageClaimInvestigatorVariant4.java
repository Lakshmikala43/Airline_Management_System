...
/**
 * Lost Luggage Claim Investigation and Compensation Processor - Production Component Variant 4
 */
public class LostLuggageClaimInvestigatorVariant4 {
    private final String serviceId = "SVC-BAGGAGE-0004";
