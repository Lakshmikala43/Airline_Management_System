...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 5
 */
public class PessimisticSeatReservationServiceVariant5 {
    private final String serviceId = "SVC-FLIGHT-0005";
