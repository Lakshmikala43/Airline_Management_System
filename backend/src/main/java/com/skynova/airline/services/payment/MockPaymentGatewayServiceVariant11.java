package com.skynova.airline.services.payment;
...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 11
 */
public class MockPaymentGatewayServiceVariant11 {
    private final String serviceId = "SVC-PAYMENT-0011";
