...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 5
 */
public class TicketQRAuthenticationServiceVariant5 {
    private final String serviceId = "SVC-SECURITY-0005";
