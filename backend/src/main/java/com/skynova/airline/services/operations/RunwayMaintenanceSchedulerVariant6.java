...
/**
 * Runway Availability and Maintenance Operational Scheduler - Production Component Variant 6
 */
public class RunwayMaintenanceSchedulerVariant6 {
    private final String serviceId = "SVC-OPERATIONS-0006";
