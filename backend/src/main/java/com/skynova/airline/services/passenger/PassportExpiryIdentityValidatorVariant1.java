...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 1
 */
public class PassportExpiryIdentityValidatorVariant1 {
    private final String serviceId = "SVC-PASSENGER-0001";
