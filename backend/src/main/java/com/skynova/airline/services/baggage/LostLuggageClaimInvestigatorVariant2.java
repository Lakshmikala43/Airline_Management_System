...
/**
 * Lost Luggage Claim Investigation and Compensation Processor - Production Component Variant 2
 */
public class LostLuggageClaimInvestigatorVariant2 {
    private final String serviceId = "SVC-BAGGAGE-0002";
