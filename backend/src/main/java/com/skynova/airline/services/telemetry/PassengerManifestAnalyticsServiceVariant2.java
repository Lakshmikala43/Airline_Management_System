...
/**
 * Flight Passenger Manifest and Revenue Analytics Service - Production Component Variant 2
 */
public class PassengerManifestAnalyticsServiceVariant2 {
    private final String serviceId = "SVC-TELEMETRY-0002";
