...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 8
 */
public class CustomerLoyaltyTierCalculatorVariant8 {
    private final String serviceId = "SVC-LOYALTY-0008";
