...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 8
 */
public class AircraftFleetInspectorServiceVariant8 {
    private final String serviceId = "SVC-FLEET-0008";
