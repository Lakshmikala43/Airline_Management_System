...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 2
 */
public class MockPaymentGatewayServiceVariant2 {
    private final String serviceId = "SVC-PAYMENT-0002";
