...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 5
 */
public class ExecutiveReportCSVGeneratorVariant5 {
    private final String serviceId = "SVC-REPORTS-0005";
