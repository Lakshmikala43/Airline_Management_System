package com.skynova.airline.services.fleet;
...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 13
 */
public class AircraftFleetInspectorServiceVariant13 {
    private final String serviceId = "SVC-FLEET-0013";
