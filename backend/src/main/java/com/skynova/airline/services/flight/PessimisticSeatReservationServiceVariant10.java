package com.skynova.airline.services.flight;
...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 10
 */
public class PessimisticSeatReservationServiceVariant10 {
    private final String serviceId = "SVC-FLIGHT-0010";
