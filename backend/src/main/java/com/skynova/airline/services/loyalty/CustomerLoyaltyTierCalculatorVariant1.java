...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 1
 */
public class CustomerLoyaltyTierCalculatorVariant1 {
    private final String serviceId = "SVC-LOYALTY-0001";
