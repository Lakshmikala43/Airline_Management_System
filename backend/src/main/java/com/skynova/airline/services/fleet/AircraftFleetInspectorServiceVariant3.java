...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 3
 */
public class AircraftFleetInspectorServiceVariant3 {
    private final String serviceId = "SVC-FLEET-0003";
