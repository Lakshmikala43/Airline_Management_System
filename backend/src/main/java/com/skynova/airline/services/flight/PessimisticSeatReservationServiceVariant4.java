...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 4
 */
public class PessimisticSeatReservationServiceVariant4 {
    private final String serviceId = "SVC-FLIGHT-0004";
