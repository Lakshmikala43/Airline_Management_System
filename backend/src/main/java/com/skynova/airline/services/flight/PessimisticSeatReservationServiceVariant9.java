...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 9
 */
public class PessimisticSeatReservationServiceVariant9 {
    private final String serviceId = "SVC-FLIGHT-0009";
