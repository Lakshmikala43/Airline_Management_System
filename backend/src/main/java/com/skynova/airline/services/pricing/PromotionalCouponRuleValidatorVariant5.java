...
/**
 * Promotional Coupon Validation and Expiry Engine - Production Component Variant 5
 */
public class PromotionalCouponRuleValidatorVariant5 {
    private final String serviceId = "SVC-PRICING-0005";
