...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 12
 */
public class TicketQRAuthenticationServiceVariant12 {
    private final String serviceId = "SVC-SECURITY-0012";
