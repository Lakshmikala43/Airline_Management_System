...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 14
 */
public class PessimisticSeatReservationServiceVariant14 {
    private final String serviceId = "SVC-FLIGHT-0014";
