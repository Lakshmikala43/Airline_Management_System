...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 9
 */
public class CustomerLoyaltyTierCalculatorVariant9 {
    private final String serviceId = "SVC-LOYALTY-0009";
