...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 4
 */
public class MockPaymentGatewayServiceVariant4 {
    private final String serviceId = "SVC-PAYMENT-0004";
