...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 10
 */
public class PassportExpiryIdentityValidatorVariant10 {
    private final String serviceId = "SVC-PASSENGER-0010";
