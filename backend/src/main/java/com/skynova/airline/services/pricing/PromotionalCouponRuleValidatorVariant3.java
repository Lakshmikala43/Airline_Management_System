...
/**
 * Promotional Coupon Validation and Expiry Engine - Production Component Variant 3
 */
public class PromotionalCouponRuleValidatorVariant3 {
    private final String serviceId = "SVC-PRICING-0003";
