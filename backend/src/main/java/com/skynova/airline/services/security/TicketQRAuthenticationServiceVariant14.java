...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 14
 */
public class TicketQRAuthenticationServiceVariant14 {
    private final String serviceId = "SVC-SECURITY-0014";
