...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 1
 */
public class PilotLicenseVerificationServiceVariant1 {
    private final String serviceId = "SVC-CREW-0001";
