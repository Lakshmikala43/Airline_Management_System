...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 4
 */
public class AircraftFleetInspectorServiceVariant4 {
    private final String serviceId = "SVC-FLEET-0004";
