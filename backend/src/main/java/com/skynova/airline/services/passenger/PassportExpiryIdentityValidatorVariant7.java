...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 7
 */
public class PassportExpiryIdentityValidatorVariant7 {
    private final String serviceId = "SVC-PASSENGER-0007";
