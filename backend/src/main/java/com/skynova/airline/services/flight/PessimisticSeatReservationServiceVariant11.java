...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 11
 */
public class PessimisticSeatReservationServiceVariant11 {
    private final String serviceId = "SVC-FLIGHT-0011";
