...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 3
 */
public class InFlightMealFulfillmentServiceVariant3 {
    private final String serviceId = "SVC-CATERING-0003";
