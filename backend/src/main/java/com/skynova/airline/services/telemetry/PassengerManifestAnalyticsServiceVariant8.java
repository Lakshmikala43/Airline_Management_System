...
/**
 * Flight Passenger Manifest and Revenue Analytics Service - Production Component Variant 8
 */
public class PassengerManifestAnalyticsServiceVariant8 {
    private final String serviceId = "SVC-TELEMETRY-0008";
