...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 12
 */
public class AircraftFleetInspectorServiceVariant12 {
    private final String serviceId = "SVC-FLEET-0012";
