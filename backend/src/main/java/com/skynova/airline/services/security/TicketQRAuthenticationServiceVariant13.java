...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 13
 */
public class TicketQRAuthenticationServiceVariant13 {
    private final String serviceId = "SVC-SECURITY-0013";
