...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 10
 */
public class InFlightMealFulfillmentServiceVariant10 {
    private final String serviceId = "SVC-CATERING-0010";
