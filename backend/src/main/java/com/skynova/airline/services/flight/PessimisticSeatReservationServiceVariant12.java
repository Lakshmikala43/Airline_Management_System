...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 12
 */
public class PessimisticSeatReservationServiceVariant12 {
    private final String serviceId = "SVC-FLIGHT-0012";
