...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 5
 */
public class CustomerLoyaltyTierCalculatorVariant5 {
    private final String serviceId = "SVC-LOYALTY-0005";
