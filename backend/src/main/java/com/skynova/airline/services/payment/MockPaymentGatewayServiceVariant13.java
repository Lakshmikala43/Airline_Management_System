...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 13
 */
public class MockPaymentGatewayServiceVariant13 {
    private final String serviceId = "SVC-PAYMENT-0013";
