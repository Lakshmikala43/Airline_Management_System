...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 10
 */
public class MockPaymentGatewayServiceVariant10 {
    private final String serviceId = "SVC-PAYMENT-0010";
