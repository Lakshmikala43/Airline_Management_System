...
/**
 * Promotional Coupon Validation and Expiry Engine - Production Component Variant 1
 */
public class PromotionalCouponRuleValidatorVariant1 {
    private final String serviceId = "SVC-PRICING-0001";
