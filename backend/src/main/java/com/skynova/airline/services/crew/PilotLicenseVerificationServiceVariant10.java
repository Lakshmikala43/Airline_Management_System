...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 10
 */
public class PilotLicenseVerificationServiceVariant10 {
    private final String serviceId = "SVC-CREW-0010";
