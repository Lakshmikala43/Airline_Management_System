...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 10
 */
public class AircraftFleetInspectorServiceVariant10 {
    private final String serviceId = "SVC-FLEET-0010";
