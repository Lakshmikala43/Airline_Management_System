...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 14
 */
public class InFlightMealFulfillmentServiceVariant14 {
    private final String serviceId = "SVC-CATERING-0014";
