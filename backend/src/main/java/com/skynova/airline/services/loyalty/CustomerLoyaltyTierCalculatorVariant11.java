...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 11
 */
public class CustomerLoyaltyTierCalculatorVariant11 {
    private final String serviceId = "SVC-LOYALTY-0011";
