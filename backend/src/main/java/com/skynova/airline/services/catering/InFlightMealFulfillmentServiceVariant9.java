...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 9
 */
public class InFlightMealFulfillmentServiceVariant9 {
    private final String serviceId = "SVC-CATERING-0009";
