...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 4
 */
public class CustomerLoyaltyTierCalculatorVariant4 {
    private final String serviceId = "SVC-LOYALTY-0004";
