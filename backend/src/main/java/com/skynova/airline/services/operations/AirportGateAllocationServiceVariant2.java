...
/**
 * Airport Gate Allocation and Conflict Resolution Service - Production Component Variant 2
 */
public class AirportGateAllocationServiceVariant2 {
    private final String serviceId = "SVC-OPERATIONS-0002";
