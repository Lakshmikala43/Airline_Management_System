...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 1
 */
public class TicketQRAuthenticationServiceVariant1 {
    private final String serviceId = "SVC-SECURITY-0001";
