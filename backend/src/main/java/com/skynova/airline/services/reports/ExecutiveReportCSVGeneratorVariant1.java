...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 1
 */
public class ExecutiveReportCSVGeneratorVariant1 {
    private final String serviceId = "SVC-REPORTS-0001";
