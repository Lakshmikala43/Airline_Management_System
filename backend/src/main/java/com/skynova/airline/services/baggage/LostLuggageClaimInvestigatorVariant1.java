...
/**
 * Lost Luggage Claim Investigation and Compensation Processor - Production Component Variant 1
 */
public class LostLuggageClaimInvestigatorVariant1 {
    private final String serviceId = "SVC-BAGGAGE-0001";
