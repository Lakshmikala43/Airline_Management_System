package com.skynova.airline.services.security;
...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 10
 */
public class TicketQRAuthenticationServiceVariant10 {
    private final String serviceId = "SVC-SECURITY-0010";
