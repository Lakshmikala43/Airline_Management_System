...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 3
 */
public class PessimisticSeatReservationServiceVariant3 {
    private final String serviceId = "SVC-FLIGHT-0003";
