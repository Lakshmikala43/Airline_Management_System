...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 2
 */
public class PassportExpiryIdentityValidatorVariant2 {
    private final String serviceId = "SVC-PASSENGER-0002";
