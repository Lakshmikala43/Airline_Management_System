...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 13
 */
public class InFlightMealFulfillmentServiceVariant13 {
    private final String serviceId = "SVC-CATERING-0013";
