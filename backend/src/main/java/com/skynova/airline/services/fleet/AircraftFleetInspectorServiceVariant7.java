...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 7
 */
public class AircraftFleetInspectorServiceVariant7 {
    private final String serviceId = "SVC-FLEET-0007";
