...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 7
 */
public class InFlightMealFulfillmentServiceVariant7 {
    private final String serviceId = "SVC-CATERING-0007";
