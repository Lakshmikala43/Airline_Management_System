package com.skynova.airline.services.loyalty;
...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 10
 */
public class CustomerLoyaltyTierCalculatorVariant10 {
    private final String serviceId = "SVC-LOYALTY-0010";
