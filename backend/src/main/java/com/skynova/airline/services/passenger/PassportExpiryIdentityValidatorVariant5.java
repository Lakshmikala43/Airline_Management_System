...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 5
 */
public class PassportExpiryIdentityValidatorVariant5 {
    private final String serviceId = "SVC-PASSENGER-0005";
