...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 6
 */
public class AircraftFleetInspectorServiceVariant6 {
    private final String serviceId = "SVC-FLEET-0006";
