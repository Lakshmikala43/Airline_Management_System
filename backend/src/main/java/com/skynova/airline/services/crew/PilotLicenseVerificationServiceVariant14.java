...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 14
 */
public class PilotLicenseVerificationServiceVariant14 {
    private final String serviceId = "SVC-CREW-0014";
