...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 1
 */
public class AircraftFleetInspectorServiceVariant1 {
    private final String serviceId = "SVC-FLEET-0001";
