...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 9
 */
public class MockPaymentGatewayServiceVariant9 {
    private final String serviceId = "SVC-PAYMENT-0009";
