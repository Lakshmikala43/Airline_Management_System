...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 5
 */
public class InFlightMealFulfillmentServiceVariant5 {
    private final String serviceId = "SVC-CATERING-0005";
