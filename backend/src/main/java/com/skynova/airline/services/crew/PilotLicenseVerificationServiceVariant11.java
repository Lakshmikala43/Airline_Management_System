...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 11
 */
public class PilotLicenseVerificationServiceVariant11 {
    private final String serviceId = "SVC-CREW-0011";
