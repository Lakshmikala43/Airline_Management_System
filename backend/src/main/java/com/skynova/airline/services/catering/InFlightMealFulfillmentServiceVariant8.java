...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 8
 */
public class InFlightMealFulfillmentServiceVariant8 {
    private final String serviceId = "SVC-CATERING-0008";
