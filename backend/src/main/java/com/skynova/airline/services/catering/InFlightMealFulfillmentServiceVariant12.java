...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 12
 */
public class InFlightMealFulfillmentServiceVariant12 {
    private final String serviceId = "SVC-CATERING-0012";
