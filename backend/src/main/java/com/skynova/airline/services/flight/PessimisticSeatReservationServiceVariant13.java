...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 13
 */
public class PessimisticSeatReservationServiceVariant13 {
    private final String serviceId = "SVC-FLIGHT-0013";
