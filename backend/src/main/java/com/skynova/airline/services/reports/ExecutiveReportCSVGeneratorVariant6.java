...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 6
 */
public class ExecutiveReportCSVGeneratorVariant6 {
    private final String serviceId = "SVC-REPORTS-0006";
