...
/**
 * Aircraft Fleet Health and Operational Inspector - Production Component Variant 5
 */
public class AircraftFleetInspectorServiceVariant5 {
    private final String serviceId = "SVC-FLEET-0005";
