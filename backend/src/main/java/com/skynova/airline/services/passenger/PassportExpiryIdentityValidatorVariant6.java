...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 6
 */
public class PassportExpiryIdentityValidatorVariant6 {
    private final String serviceId = "SVC-PASSENGER-0006";
