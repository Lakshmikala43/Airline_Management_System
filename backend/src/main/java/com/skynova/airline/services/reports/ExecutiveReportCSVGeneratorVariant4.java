...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 4
 */
public class ExecutiveReportCSVGeneratorVariant4 {
    private final String serviceId = "SVC-REPORTS-0004";
