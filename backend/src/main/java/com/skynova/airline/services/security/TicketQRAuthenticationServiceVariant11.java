...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 11
 */
public class TicketQRAuthenticationServiceVariant11 {
    private final String serviceId = "SVC-SECURITY-0011";
