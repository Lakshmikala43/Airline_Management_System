...
/**
 * Flight Passenger Manifest and Revenue Analytics Service - Production Component Variant 1
 */
public class PassengerManifestAnalyticsServiceVariant1 {
    private final String serviceId = "SVC-TELEMETRY-0001";
