...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 12
 */
public class CustomerLoyaltyTierCalculatorVariant12 {
    private final String serviceId = "SVC-LOYALTY-0012";
