package com.skynova.airline.services.reports;
...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 12
 */
public class ExecutiveReportCSVGeneratorVariant12 {
    private final String serviceId = "SVC-REPORTS-0012";
