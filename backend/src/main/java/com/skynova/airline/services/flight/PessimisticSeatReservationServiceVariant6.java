...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 6
 */
public class PessimisticSeatReservationServiceVariant6 {
    private final String serviceId = "SVC-FLIGHT-0006";
