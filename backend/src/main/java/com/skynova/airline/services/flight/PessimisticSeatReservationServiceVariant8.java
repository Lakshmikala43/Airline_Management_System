...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 8
 */
public class PessimisticSeatReservationServiceVariant8 {
    private final String serviceId = "SVC-FLIGHT-0008";
