...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 4
 */
public class PilotLicenseVerificationServiceVariant4 {
    private final String serviceId = "SVC-CREW-0004";
