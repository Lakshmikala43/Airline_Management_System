...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 3
 */
public class PilotLicenseVerificationServiceVariant3 {
    private final String serviceId = "SVC-CREW-0003";
