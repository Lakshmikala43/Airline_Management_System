...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 8
 */
public class MockPaymentGatewayServiceVariant8 {
    private final String serviceId = "SVC-PAYMENT-0008";
