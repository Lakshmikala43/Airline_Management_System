...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 6
 */
public class PilotLicenseVerificationServiceVariant6 {
    private final String serviceId = "SVC-CREW-0006";
