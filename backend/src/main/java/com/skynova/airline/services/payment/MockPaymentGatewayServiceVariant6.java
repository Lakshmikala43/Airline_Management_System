...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 6
 */
public class MockPaymentGatewayServiceVariant6 {
    private final String serviceId = "SVC-PAYMENT-0006";
