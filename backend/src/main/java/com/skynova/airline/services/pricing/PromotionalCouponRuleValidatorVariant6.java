...
/**
 * Promotional Coupon Validation and Expiry Engine - Production Component Variant 6
 */
public class PromotionalCouponRuleValidatorVariant6 {
    private final String serviceId = "SVC-PRICING-0006";
