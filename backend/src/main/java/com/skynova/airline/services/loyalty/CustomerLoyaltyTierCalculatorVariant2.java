...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 2
 */
public class CustomerLoyaltyTierCalculatorVariant2 {
    private final String serviceId = "SVC-LOYALTY-0002";
