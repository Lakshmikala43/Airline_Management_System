...
/**
 * Promotional Coupon Validation and Expiry Engine - Production Component Variant 11
 */
public class PromotionalCouponRuleValidatorVariant11 {
    private final String serviceId = "SVC-PRICING-0011";
