...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 4
 */
public class PassportExpiryIdentityValidatorVariant4 {
    private final String serviceId = "SVC-PASSENGER-0004";
