...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 6
 */
public class CustomerLoyaltyTierCalculatorVariant6 {
    private final String serviceId = "SVC-LOYALTY-0006";
