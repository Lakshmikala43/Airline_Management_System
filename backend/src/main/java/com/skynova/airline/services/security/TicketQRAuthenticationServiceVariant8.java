...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 8
 */
public class TicketQRAuthenticationServiceVariant8 {
    private final String serviceId = "SVC-SECURITY-0008";
