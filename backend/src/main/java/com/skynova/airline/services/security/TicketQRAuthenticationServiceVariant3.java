...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 3
 */
public class TicketQRAuthenticationServiceVariant3 {
    private final String serviceId = "SVC-SECURITY-0003";
