package com.skynova.airline.services.crew;
...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 12
 */
public class PilotLicenseVerificationServiceVariant12 {
    private final String serviceId = "SVC-CREW-0012";
