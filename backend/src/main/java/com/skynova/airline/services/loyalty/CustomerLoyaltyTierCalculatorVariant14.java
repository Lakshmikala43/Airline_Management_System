...
/**
 * Frequent Flyer Loyalty Tier and Reward Calculator - Production Component Variant 14
 */
public class CustomerLoyaltyTierCalculatorVariant14 {
    private final String serviceId = "SVC-LOYALTY-0014";
