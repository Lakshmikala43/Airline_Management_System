...
/**
 * Runway Availability and Maintenance Operational Scheduler - Production Component Variant 10
 */
public class RunwayMaintenanceSchedulerVariant10 {
    private final String serviceId = "SVC-OPERATIONS-0010";
