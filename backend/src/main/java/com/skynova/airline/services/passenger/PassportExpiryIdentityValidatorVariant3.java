...
/**
 * Passenger Identity and Passport Expiry Inspector - Production Component Variant 3
 */
public class PassportExpiryIdentityValidatorVariant3 {
    private final String serviceId = "SVC-PASSENGER-0003";
