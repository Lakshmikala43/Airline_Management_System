...
/**
 * Transaction-Safe Seat Locking and Reservation Service - Production Component Variant 2
 */
public class PessimisticSeatReservationServiceVariant2 {
    private final String serviceId = "SVC-FLIGHT-0002";
