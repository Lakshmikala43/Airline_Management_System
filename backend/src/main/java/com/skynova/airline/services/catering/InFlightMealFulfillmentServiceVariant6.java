...
/**
 * In-Flight Catering and Meal Order Fulfillment Service - Production Component Variant 6
 */
public class InFlightMealFulfillmentServiceVariant6 {
    private final String serviceId = "SVC-CATERING-0006";
