...
/**
 * Operations Executive Summary CSV Report Exporter - Production Component Variant 3
 */
public class ExecutiveReportCSVGeneratorVariant3 {
    private final String serviceId = "SVC-REPORTS-0003";
