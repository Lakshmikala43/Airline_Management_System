...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 1
 */
public class MockPaymentGatewayServiceVariant1 {
    private final String serviceId = "SVC-PAYMENT-0001";
