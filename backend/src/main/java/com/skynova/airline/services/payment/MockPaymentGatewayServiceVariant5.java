...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 5
 */
public class MockPaymentGatewayServiceVariant5 {
    private final String serviceId = "SVC-PAYMENT-0005";
