...
/**
 * Electronic Ticket QR Code Authentication Service - Production Component Variant 4
 */
public class TicketQRAuthenticationServiceVariant4 {
    private final String serviceId = "SVC-SECURITY-0004";
