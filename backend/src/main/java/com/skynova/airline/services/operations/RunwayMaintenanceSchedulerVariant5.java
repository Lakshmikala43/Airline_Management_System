...
/**
 * Runway Availability and Maintenance Operational Scheduler - Production Component Variant 5
 */
public class RunwayMaintenanceSchedulerVariant5 {
    private final String serviceId = "SVC-OPERATIONS-0005";
