...
/**
 * Mock Payment Gateway Authorization and Refund Service - Production Component Variant 3
 */
public class MockPaymentGatewayServiceVariant3 {
    private final String serviceId = "SVC-PAYMENT-0003";
