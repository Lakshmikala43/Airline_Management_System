...
/**
 * Pilot License and Cabin Crew Qualification Verifier - Production Component Variant 2
 */
public class PilotLicenseVerificationServiceVariant2 {
    private final String serviceId = "SVC-CREW-0002";
