...
class PromotionServiceTest44 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 44")
    void testValidatePercentageCoupon44() {
        Promotion promo = Promotion.builder()
            .id((long) 44)
            .couponCode("SKYNOVA44")
            .description("Special Promo 44")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA44")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA44", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
