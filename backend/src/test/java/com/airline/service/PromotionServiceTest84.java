...
class PromotionServiceTest84 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 84")
    void testValidatePercentageCoupon84() {
        Promotion promo = Promotion.builder()
            .id((long) 84)
            .couponCode("SKYNOVA84")
            .description("Special Promo 84")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA84")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA84", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
