...
class PromotionServiceTest19 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 19")
    void testValidatePercentageCoupon19() {
        Promotion promo = Promotion.builder()
            .id((long) 19)
            .couponCode("SKYNOVA19")
            .description("Special Promo 19")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA19")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA19", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
