...
class PromotionServiceTest86 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 86")
    void testValidatePercentageCoupon86() {
        Promotion promo = Promotion.builder()
            .id((long) 86)
            .couponCode("SKYNOVA86")
            .description("Special Promo 86")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA86")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA86", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
