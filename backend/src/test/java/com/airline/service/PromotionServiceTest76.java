...
class PromotionServiceTest76 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 76")
    void testValidatePercentageCoupon76() {
        Promotion promo = Promotion.builder()
            .id((long) 76)
            .couponCode("SKYNOVA76")
            .description("Special Promo 76")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA76")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA76", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
