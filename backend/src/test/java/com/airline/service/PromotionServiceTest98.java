...
class PromotionServiceTest98 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 98")
    void testValidatePercentageCoupon98() {
        Promotion promo = Promotion.builder()
            .id((long) 98)
            .couponCode("SKYNOVA98")
            .description("Special Promo 98")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA98")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA98", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
