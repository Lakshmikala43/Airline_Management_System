...
class PromotionServiceTest57 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 57")
    void testValidatePercentageCoupon57() {
        Promotion promo = Promotion.builder()
            .id((long) 57)
            .couponCode("SKYNOVA57")
            .description("Special Promo 57")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA57")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA57", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
