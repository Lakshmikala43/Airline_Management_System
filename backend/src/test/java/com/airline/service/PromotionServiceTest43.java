...
class PromotionServiceTest43 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 43")
    void testValidatePercentageCoupon43() {
        Promotion promo = Promotion.builder()
            .id((long) 43)
            .couponCode("SKYNOVA43")
            .description("Special Promo 43")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA43")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA43", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
