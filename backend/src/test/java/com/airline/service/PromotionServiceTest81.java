...
class PromotionServiceTest81 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 81")
    void testValidatePercentageCoupon81() {
        Promotion promo = Promotion.builder()
            .id((long) 81)
            .couponCode("SKYNOVA81")
            .description("Special Promo 81")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA81")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA81", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
