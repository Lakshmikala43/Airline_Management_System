...
class WeatherDelaySimulationServiceTest26 {
    ...
    @Test
    @DisplayName("Verify airport weather forecast and delay risk evaluation - Suite 26")
    void testGetWeatherReportSuite26() {
