...
class WeatherDelaySimulationServiceTest24 {
    ...
    @Test
    @DisplayName("Verify airport weather forecast and delay risk evaluation - Suite 24")
    void testGetWeatherReportSuite24() {
