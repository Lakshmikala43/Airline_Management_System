...
class PromotionServiceTest71 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 71")
    void testValidatePercentageCoupon71() {
        Promotion promo = Promotion.builder()
            .id((long) 71)
            .couponCode("SKYNOVA71")
            .description("Special Promo 71")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA71")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA71", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
