...
class CurrencyExchangeServiceTest8 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 8")
    void testUsdToEurConversion8() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 8")
    void testUsdToInrConversion8() {
