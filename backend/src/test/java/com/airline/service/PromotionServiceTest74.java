...
class PromotionServiceTest74 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 74")
    void testValidatePercentageCoupon74() {
        Promotion promo = Promotion.builder()
            .id((long) 74)
            .couponCode("SKYNOVA74")
            .description("Special Promo 74")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA74")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA74", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
