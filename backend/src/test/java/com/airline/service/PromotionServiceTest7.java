...
class PromotionServiceTest7 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 7")
    void testValidatePercentageCoupon7() {
        Promotion promo = Promotion.builder()
            .id((long) 7)
            .couponCode("SKYNOVA7")
            .description("Special Promo 7")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA7")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA7", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
