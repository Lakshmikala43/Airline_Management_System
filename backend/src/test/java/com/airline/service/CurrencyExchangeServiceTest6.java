...
class CurrencyExchangeServiceTest6 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 6")
    void testUsdToEurConversion6() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 6")
    void testUsdToInrConversion6() {
