...
class CurrencyExchangeServiceTest11 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 11")
    void testUsdToEurConversion11() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 11")
    void testUsdToInrConversion11() {
