...
class PromotionServiceTest97 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 97")
    void testValidatePercentageCoupon97() {
        Promotion promo = Promotion.builder()
            .id((long) 97)
            .couponCode("SKYNOVA97")
            .description("Special Promo 97")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA97")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA97", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
