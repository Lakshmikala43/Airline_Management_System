...
class WeatherDelaySimulationServiceTest10 {
    ...
    @Test
    @DisplayName("Verify airport weather forecast and delay risk evaluation - Suite 10")
    void testGetWeatherReportSuite10() {
