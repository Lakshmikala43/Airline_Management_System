...
class PromotionServiceTest58 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 58")
    void testValidatePercentageCoupon58() {
        Promotion promo = Promotion.builder()
            .id((long) 58)
            .couponCode("SKYNOVA58")
            .description("Special Promo 58")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA58")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA58", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
