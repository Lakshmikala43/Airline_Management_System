...
class PromotionServiceTest49 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 49")
    void testValidatePercentageCoupon49() {
        Promotion promo = Promotion.builder()
            .id((long) 49)
            .couponCode("SKYNOVA49")
            .description("Special Promo 49")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA49")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA49", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
