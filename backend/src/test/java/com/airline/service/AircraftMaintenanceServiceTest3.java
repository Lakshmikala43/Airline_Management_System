...
class AircraftMaintenanceServiceTest3 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 3")
    void testLogMaintenanceSuite3() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 3")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 3", "Tech 3", BigDecimal.valueOf(15000.00));
