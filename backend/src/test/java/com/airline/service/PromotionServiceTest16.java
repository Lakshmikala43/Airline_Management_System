...
class PromotionServiceTest16 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 16")
    void testValidatePercentageCoupon16() {
        Promotion promo = Promotion.builder()
            .id((long) 16)
            .couponCode("SKYNOVA16")
            .description("Special Promo 16")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA16")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA16", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
