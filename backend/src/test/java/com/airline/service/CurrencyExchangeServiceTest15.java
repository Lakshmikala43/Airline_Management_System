...
class CurrencyExchangeServiceTest15 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 15")
    void testUsdToEurConversion15() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 15")
    void testUsdToInrConversion15() {
