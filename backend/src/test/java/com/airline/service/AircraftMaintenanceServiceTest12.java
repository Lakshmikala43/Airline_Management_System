...
class AircraftMaintenanceServiceTest12 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 12")
    void testLogMaintenanceSuite12() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 12")
            .technicianName("Tech 12")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 12", "Tech 12", BigDecimal.valueOf(15000.00));
