...
class PromotionServiceTest39 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 39")
    void testValidatePercentageCoupon39() {
        Promotion promo = Promotion.builder()
            .id((long) 39)
            .couponCode("SKYNOVA39")
            .description("Special Promo 39")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA39")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA39", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
