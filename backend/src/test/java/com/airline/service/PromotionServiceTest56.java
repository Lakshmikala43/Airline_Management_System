...
class PromotionServiceTest56 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 56")
    void testValidatePercentageCoupon56() {
        Promotion promo = Promotion.builder()
            .id((long) 56)
            .couponCode("SKYNOVA56")
            .description("Special Promo 56")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA56")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA56", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
