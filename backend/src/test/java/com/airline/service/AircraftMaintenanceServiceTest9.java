...
class AircraftMaintenanceServiceTest9 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 9")
    void testLogMaintenanceSuite9() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 9")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 9", "Tech 9", BigDecimal.valueOf(15000.00));
