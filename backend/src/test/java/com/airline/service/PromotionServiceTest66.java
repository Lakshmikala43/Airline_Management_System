...
class PromotionServiceTest66 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 66")
    void testValidatePercentageCoupon66() {
        Promotion promo = Promotion.builder()
            .id((long) 66)
            .couponCode("SKYNOVA66")
            .description("Special Promo 66")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA66")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA66", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
