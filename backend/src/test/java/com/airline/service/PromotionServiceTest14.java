...
class PromotionServiceTest14 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 14")
    void testValidatePercentageCoupon14() {
        Promotion promo = Promotion.builder()
            .id((long) 14)
            .couponCode("SKYNOVA14")
            .description("Special Promo 14")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA14")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA14", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
