...
class AircraftMaintenanceServiceTest5 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 5")
    void testLogMaintenanceSuite5() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 5")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 5", "Tech 5", BigDecimal.valueOf(15000.00));
