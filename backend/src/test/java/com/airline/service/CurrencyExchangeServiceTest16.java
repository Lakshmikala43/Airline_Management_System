...
class CurrencyExchangeServiceTest16 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 16")
    void testUsdToEurConversion16() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 16")
    void testUsdToInrConversion16() {
