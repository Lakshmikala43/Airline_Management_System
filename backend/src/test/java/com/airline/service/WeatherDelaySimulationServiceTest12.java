...
class WeatherDelaySimulationServiceTest12 {
    ...
    @Test
    @DisplayName("Verify airport weather forecast and delay risk evaluation - Suite 12")
    void testGetWeatherReportSuite12() {
