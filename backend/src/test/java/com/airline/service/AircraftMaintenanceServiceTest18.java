...
class AircraftMaintenanceServiceTest18 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 18")
    void testLogMaintenanceSuite18() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 18")
            .technicianName("Tech 18")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 18", "Tech 18", BigDecimal.valueOf(15000.00));
