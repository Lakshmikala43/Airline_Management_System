...
class PromotionServiceTest96 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 96")
    void testValidatePercentageCoupon96() {
        Promotion promo = Promotion.builder()
            .id((long) 96)
            .couponCode("SKYNOVA96")
            .description("Special Promo 96")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA96")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA96", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
