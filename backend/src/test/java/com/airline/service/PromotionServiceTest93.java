...
class PromotionServiceTest93 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 93")
    void testValidatePercentageCoupon93() {
        Promotion promo = Promotion.builder()
            .id((long) 93)
            .couponCode("SKYNOVA93")
            .description("Special Promo 93")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA93")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA93", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
