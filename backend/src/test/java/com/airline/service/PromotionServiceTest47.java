...
class PromotionServiceTest47 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 47")
    void testValidatePercentageCoupon47() {
        Promotion promo = Promotion.builder()
            .id((long) 47)
            .couponCode("SKYNOVA47")
            .description("Special Promo 47")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA47")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA47", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
