...
class AircraftMaintenanceServiceTest17 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 17")
    void testLogMaintenanceSuite17() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 17")
            .technicianName("Tech 17")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 17", "Tech 17", BigDecimal.valueOf(15000.00));
