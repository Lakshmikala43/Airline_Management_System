...
class AircraftMaintenanceServiceTest14 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 14")
    void testLogMaintenanceSuite14() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 14")
            .technicianName("Tech 14")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 14", "Tech 14", BigDecimal.valueOf(15000.00));
