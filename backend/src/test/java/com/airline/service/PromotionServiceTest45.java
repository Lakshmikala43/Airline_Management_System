...
class PromotionServiceTest45 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 45")
    void testValidatePercentageCoupon45() {
        Promotion promo = Promotion.builder()
            .id((long) 45)
            .couponCode("SKYNOVA45")
            .description("Special Promo 45")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA45")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA45", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
