...
class CurrencyExchangeServiceTest4 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 4")
    void testUsdToEurConversion4() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 4")
    void testUsdToInrConversion4() {
