...
class WeatherDelaySimulationServiceTest17 {
    ...
    @Test
    @DisplayName("Verify airport weather forecast and delay risk evaluation - Suite 17")
    void testGetWeatherReportSuite17() {
