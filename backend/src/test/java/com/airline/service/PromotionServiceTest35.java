...
class PromotionServiceTest35 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 35")
    void testValidatePercentageCoupon35() {
        Promotion promo = Promotion.builder()
            .id((long) 35)
            .couponCode("SKYNOVA35")
            .description("Special Promo 35")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA35")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA35", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
