...
class PromotionServiceTest89 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 89")
    void testValidatePercentageCoupon89() {
        Promotion promo = Promotion.builder()
            .id((long) 89)
            .couponCode("SKYNOVA89")
            .description("Special Promo 89")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA89")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA89", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
