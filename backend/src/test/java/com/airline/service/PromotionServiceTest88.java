...
class PromotionServiceTest88 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 88")
    void testValidatePercentageCoupon88() {
        Promotion promo = Promotion.builder()
            .id((long) 88)
            .couponCode("SKYNOVA88")
            .description("Special Promo 88")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA88")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA88", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
