...
class WeatherDelaySimulationServiceTest18 {
    ...
    @Test
    @DisplayName("Verify airport weather forecast and delay risk evaluation - Suite 18")
    void testGetWeatherReportSuite18() {
