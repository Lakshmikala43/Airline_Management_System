...
class PromotionServiceTest70 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 70")
    void testValidatePercentageCoupon70() {
        Promotion promo = Promotion.builder()
            .id((long) 70)
            .couponCode("SKYNOVA70")
            .description("Special Promo 70")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA70")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA70", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
