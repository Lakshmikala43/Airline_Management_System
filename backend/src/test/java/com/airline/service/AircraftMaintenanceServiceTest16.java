...
class AircraftMaintenanceServiceTest16 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 16")
    void testLogMaintenanceSuite16() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 16")
            .technicianName("Tech 16")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 16", "Tech 16", BigDecimal.valueOf(15000.00));
