...
class PromotionServiceTest95 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 95")
    void testValidatePercentageCoupon95() {
        Promotion promo = Promotion.builder()
            .id((long) 95)
            .couponCode("SKYNOVA95")
            .description("Special Promo 95")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA95")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA95", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
