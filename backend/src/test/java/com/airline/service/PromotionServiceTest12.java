...
class PromotionServiceTest12 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 12")
    void testValidatePercentageCoupon12() {
        Promotion promo = Promotion.builder()
            .id((long) 12)
            .couponCode("SKYNOVA12")
            .description("Special Promo 12")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA12")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA12", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
