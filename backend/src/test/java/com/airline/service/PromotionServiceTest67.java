...
class PromotionServiceTest67 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 67")
    void testValidatePercentageCoupon67() {
        Promotion promo = Promotion.builder()
            .id((long) 67)
            .couponCode("SKYNOVA67")
            .description("Special Promo 67")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA67")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA67", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
