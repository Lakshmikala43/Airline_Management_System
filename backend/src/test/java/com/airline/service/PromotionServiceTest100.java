...
class PromotionServiceTest100 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 100")
    void testValidatePercentageCoupon100() {
        Promotion promo = Promotion.builder()
            .id((long) 100)
            .couponCode("SKYNOVA100")
            .description("Special Promo 100")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA100")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA100", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
