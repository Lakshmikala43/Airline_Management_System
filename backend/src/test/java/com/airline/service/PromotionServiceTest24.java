...
class PromotionServiceTest24 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 24")
    void testValidatePercentageCoupon24() {
        Promotion promo = Promotion.builder()
            .id((long) 24)
            .couponCode("SKYNOVA24")
            .description("Special Promo 24")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA24")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA24", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
