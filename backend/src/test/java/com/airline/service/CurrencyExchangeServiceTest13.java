...
class CurrencyExchangeServiceTest13 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 13")
    void testUsdToEurConversion13() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 13")
    void testUsdToInrConversion13() {
