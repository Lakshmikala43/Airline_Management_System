...
class CurrencyExchangeServiceTest9 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 9")
    void testUsdToEurConversion9() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 9")
    void testUsdToInrConversion9() {
