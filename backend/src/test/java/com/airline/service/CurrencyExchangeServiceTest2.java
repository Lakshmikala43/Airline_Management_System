...
class CurrencyExchangeServiceTest2 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 2")
    void testUsdToEurConversion2() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 2")
    void testUsdToInrConversion2() {
