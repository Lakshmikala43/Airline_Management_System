...
class PromotionServiceTest91 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 91")
    void testValidatePercentageCoupon91() {
        Promotion promo = Promotion.builder()
            .id((long) 91)
            .couponCode("SKYNOVA91")
            .description("Special Promo 91")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA91")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA91", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
