...
class PromotionServiceTest40 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 40")
    void testValidatePercentageCoupon40() {
        Promotion promo = Promotion.builder()
            .id((long) 40)
            .couponCode("SKYNOVA40")
            .description("Special Promo 40")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA40")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA40", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
