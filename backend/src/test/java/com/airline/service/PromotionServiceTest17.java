...
class PromotionServiceTest17 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 17")
    void testValidatePercentageCoupon17() {
        Promotion promo = Promotion.builder()
            .id((long) 17)
            .couponCode("SKYNOVA17")
            .description("Special Promo 17")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA17")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA17", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
