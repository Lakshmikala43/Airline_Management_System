...
class PromotionServiceTest54 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 54")
    void testValidatePercentageCoupon54() {
        Promotion promo = Promotion.builder()
            .id((long) 54)
            .couponCode("SKYNOVA54")
            .description("Special Promo 54")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA54")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA54", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
