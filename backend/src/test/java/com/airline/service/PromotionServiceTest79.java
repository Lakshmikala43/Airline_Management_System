...
class PromotionServiceTest79 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 79")
    void testValidatePercentageCoupon79() {
        Promotion promo = Promotion.builder()
            .id((long) 79)
            .couponCode("SKYNOVA79")
            .description("Special Promo 79")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA79")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA79", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
