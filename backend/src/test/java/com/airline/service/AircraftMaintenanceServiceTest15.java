...
class AircraftMaintenanceServiceTest15 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 15")
    void testLogMaintenanceSuite15() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 15")
            .technicianName("Tech 15")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 15", "Tech 15", BigDecimal.valueOf(15000.00));
