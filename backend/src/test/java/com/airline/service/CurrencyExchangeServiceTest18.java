...
class CurrencyExchangeServiceTest18 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 18")
    void testUsdToEurConversion18() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 18")
    void testUsdToInrConversion18() {
