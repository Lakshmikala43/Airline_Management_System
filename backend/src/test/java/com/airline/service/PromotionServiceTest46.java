...
class PromotionServiceTest46 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 46")
    void testValidatePercentageCoupon46() {
        Promotion promo = Promotion.builder()
            .id((long) 46)
            .couponCode("SKYNOVA46")
            .description("Special Promo 46")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA46")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA46", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
