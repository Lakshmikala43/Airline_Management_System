...
class PromotionServiceTest87 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 87")
    void testValidatePercentageCoupon87() {
        Promotion promo = Promotion.builder()
            .id((long) 87)
            .couponCode("SKYNOVA87")
            .description("Special Promo 87")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA87")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA87", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
