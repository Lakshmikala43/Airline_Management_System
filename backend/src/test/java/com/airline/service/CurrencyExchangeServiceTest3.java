...
class CurrencyExchangeServiceTest3 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 3")
    void testUsdToEurConversion3() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 3")
    void testUsdToInrConversion3() {
