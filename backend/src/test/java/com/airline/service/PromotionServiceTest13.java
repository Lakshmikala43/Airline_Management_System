...
class PromotionServiceTest13 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 13")
    void testValidatePercentageCoupon13() {
        Promotion promo = Promotion.builder()
            .id((long) 13)
            .couponCode("SKYNOVA13")
            .description("Special Promo 13")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA13")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA13", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
