...
class CurrencyExchangeServiceTest7 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 7")
    void testUsdToEurConversion7() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 7")
    void testUsdToInrConversion7() {
