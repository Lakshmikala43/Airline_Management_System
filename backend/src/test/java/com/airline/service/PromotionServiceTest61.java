...
class PromotionServiceTest61 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 61")
    void testValidatePercentageCoupon61() {
        Promotion promo = Promotion.builder()
            .id((long) 61)
            .couponCode("SKYNOVA61")
            .description("Special Promo 61")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA61")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA61", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
