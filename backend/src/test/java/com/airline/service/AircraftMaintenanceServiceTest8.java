...
class AircraftMaintenanceServiceTest8 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 8")
    void testLogMaintenanceSuite8() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 8")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 8", "Tech 8", BigDecimal.valueOf(15000.00));
