...
class CurrencyExchangeServiceTest12 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 12")
    void testUsdToEurConversion12() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 12")
    void testUsdToInrConversion12() {
