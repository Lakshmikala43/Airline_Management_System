...
class AircraftMaintenanceServiceTest10 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 10")
    void testLogMaintenanceSuite10() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 10")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 10", "Tech 10", BigDecimal.valueOf(15000.00));
