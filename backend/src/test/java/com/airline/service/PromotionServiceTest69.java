...
class PromotionServiceTest69 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 69")
    void testValidatePercentageCoupon69() {
        Promotion promo = Promotion.builder()
            .id((long) 69)
            .couponCode("SKYNOVA69")
            .description("Special Promo 69")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA69")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA69", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
