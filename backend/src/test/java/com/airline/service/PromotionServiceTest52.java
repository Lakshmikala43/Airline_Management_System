...
class PromotionServiceTest52 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 52")
    void testValidatePercentageCoupon52() {
        Promotion promo = Promotion.builder()
            .id((long) 52)
            .couponCode("SKYNOVA52")
            .description("Special Promo 52")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA52")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA52", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
