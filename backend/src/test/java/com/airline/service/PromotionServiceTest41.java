...
class PromotionServiceTest41 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 41")
    void testValidatePercentageCoupon41() {
        Promotion promo = Promotion.builder()
            .id((long) 41)
            .couponCode("SKYNOVA41")
            .description("Special Promo 41")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA41")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA41", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
