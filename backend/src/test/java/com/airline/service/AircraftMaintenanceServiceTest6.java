...
class AircraftMaintenanceServiceTest6 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 6")
    void testLogMaintenanceSuite6() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 6")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 6", "Tech 6", BigDecimal.valueOf(15000.00));
