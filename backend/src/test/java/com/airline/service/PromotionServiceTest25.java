...
class PromotionServiceTest25 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 25")
    void testValidatePercentageCoupon25() {
        Promotion promo = Promotion.builder()
            .id((long) 25)
            .couponCode("SKYNOVA25")
            .description("Special Promo 25")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA25")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA25", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
