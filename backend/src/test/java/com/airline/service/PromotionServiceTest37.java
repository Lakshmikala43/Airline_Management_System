...
class PromotionServiceTest37 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 37")
    void testValidatePercentageCoupon37() {
        Promotion promo = Promotion.builder()
            .id((long) 37)
            .couponCode("SKYNOVA37")
            .description("Special Promo 37")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA37")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA37", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
