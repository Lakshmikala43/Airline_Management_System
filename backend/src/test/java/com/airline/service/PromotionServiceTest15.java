...
class PromotionServiceTest15 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 15")
    void testValidatePercentageCoupon15() {
        Promotion promo = Promotion.builder()
            .id((long) 15)
            .couponCode("SKYNOVA15")
            .description("Special Promo 15")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA15")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA15", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
