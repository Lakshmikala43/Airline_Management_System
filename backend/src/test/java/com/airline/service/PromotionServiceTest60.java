...
class PromotionServiceTest60 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 60")
    void testValidatePercentageCoupon60() {
        Promotion promo = Promotion.builder()
            .id((long) 60)
            .couponCode("SKYNOVA60")
            .description("Special Promo 60")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA60")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA60", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
