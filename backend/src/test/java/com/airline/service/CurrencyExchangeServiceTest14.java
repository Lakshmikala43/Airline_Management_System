...
class CurrencyExchangeServiceTest14 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 14")
    void testUsdToEurConversion14() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 14")
    void testUsdToInrConversion14() {
