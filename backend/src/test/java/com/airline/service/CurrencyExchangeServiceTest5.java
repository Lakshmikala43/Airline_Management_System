...
class CurrencyExchangeServiceTest5 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 5")
    void testUsdToEurConversion5() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 5")
    void testUsdToInrConversion5() {
