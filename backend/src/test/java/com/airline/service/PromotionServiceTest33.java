...
class PromotionServiceTest33 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 33")
    void testValidatePercentageCoupon33() {
        Promotion promo = Promotion.builder()
            .id((long) 33)
            .couponCode("SKYNOVA33")
            .description("Special Promo 33")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA33")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA33", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
