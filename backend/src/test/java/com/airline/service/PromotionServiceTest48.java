...
class PromotionServiceTest48 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 48")
    void testValidatePercentageCoupon48() {
        Promotion promo = Promotion.builder()
            .id((long) 48)
            .couponCode("SKYNOVA48")
            .description("Special Promo 48")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA48")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA48", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
