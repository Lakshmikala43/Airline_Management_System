...
class PromotionServiceTest34 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 34")
    void testValidatePercentageCoupon34() {
        Promotion promo = Promotion.builder()
            .id((long) 34)
            .couponCode("SKYNOVA34")
            .description("Special Promo 34")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA34")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA34", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
