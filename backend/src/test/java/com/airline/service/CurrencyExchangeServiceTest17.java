...
class CurrencyExchangeServiceTest17 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 17")
    void testUsdToEurConversion17() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 17")
    void testUsdToInrConversion17() {
