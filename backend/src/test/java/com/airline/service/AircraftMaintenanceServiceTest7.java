...
class AircraftMaintenanceServiceTest7 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 7")
    void testLogMaintenanceSuite7() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 7")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 7", "Tech 7", BigDecimal.valueOf(15000.00));
