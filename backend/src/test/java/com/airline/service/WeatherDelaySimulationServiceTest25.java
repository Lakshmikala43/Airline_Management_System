...
class WeatherDelaySimulationServiceTest25 {
    ...
    @Test
    @DisplayName("Verify airport weather forecast and delay risk evaluation - Suite 25")
    void testGetWeatherReportSuite25() {
