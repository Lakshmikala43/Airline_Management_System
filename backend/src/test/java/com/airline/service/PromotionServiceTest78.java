...
class PromotionServiceTest78 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 78")
    void testValidatePercentageCoupon78() {
        Promotion promo = Promotion.builder()
            .id((long) 78)
            .couponCode("SKYNOVA78")
            .description("Special Promo 78")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA78")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA78", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
