...
class PromotionServiceTest18 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 18")
    void testValidatePercentageCoupon18() {
        Promotion promo = Promotion.builder()
            .id((long) 18)
            .couponCode("SKYNOVA18")
            .description("Special Promo 18")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA18")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA18", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
