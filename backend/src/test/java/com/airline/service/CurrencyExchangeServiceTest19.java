...
class CurrencyExchangeServiceTest19 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 19")
    void testUsdToEurConversion19() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 19")
    void testUsdToInrConversion19() {
