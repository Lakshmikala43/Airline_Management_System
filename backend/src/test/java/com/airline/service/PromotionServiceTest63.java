...
class PromotionServiceTest63 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 63")
    void testValidatePercentageCoupon63() {
        Promotion promo = Promotion.builder()
            .id((long) 63)
            .couponCode("SKYNOVA63")
            .description("Special Promo 63")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA63")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA63", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
