...
class PromotionServiceTest75 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 75")
    void testValidatePercentageCoupon75() {
        Promotion promo = Promotion.builder()
            .id((long) 75)
            .couponCode("SKYNOVA75")
            .description("Special Promo 75")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA75")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA75", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
