...
class AircraftMaintenanceServiceTest11 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 11")
    void testLogMaintenanceSuite11() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 11")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 11", "Tech 11", BigDecimal.valueOf(15000.00));
