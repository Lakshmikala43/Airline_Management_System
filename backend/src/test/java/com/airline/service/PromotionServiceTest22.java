...
class PromotionServiceTest22 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 22")
    void testValidatePercentageCoupon22() {
        Promotion promo = Promotion.builder()
            .id((long) 22)
            .couponCode("SKYNOVA22")
            .description("Special Promo 22")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA22")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA22", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
