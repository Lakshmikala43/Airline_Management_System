...
class PromotionServiceTest51 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 51")
    void testValidatePercentageCoupon51() {
        Promotion promo = Promotion.builder()
            .id((long) 51)
            .couponCode("SKYNOVA51")
            .description("Special Promo 51")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA51")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA51", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
