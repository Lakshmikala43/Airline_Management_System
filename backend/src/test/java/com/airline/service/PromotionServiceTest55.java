...
class PromotionServiceTest55 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 55")
    void testValidatePercentageCoupon55() {
        Promotion promo = Promotion.builder()
            .id((long) 55)
            .couponCode("SKYNOVA55")
            .description("Special Promo 55")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA55")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA55", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
