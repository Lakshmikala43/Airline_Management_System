...
class AircraftMaintenanceServiceTest2 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 2")
    void testLogMaintenanceSuite2() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 2")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 2", "Tech 2", BigDecimal.valueOf(15000.00));
