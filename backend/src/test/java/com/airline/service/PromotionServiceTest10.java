...
class PromotionServiceTest10 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 10")
    void testValidatePercentageCoupon10() {
        Promotion promo = Promotion.builder()
            .id((long) 10)
            .couponCode("SKYNOVA10")
            .description("Special Promo 10")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA10")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA10", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
