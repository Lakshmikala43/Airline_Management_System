...
class PromotionServiceTest62 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 62")
    void testValidatePercentageCoupon62() {
        Promotion promo = Promotion.builder()
            .id((long) 62)
            .couponCode("SKYNOVA62")
            .description("Special Promo 62")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA62")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA62", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
