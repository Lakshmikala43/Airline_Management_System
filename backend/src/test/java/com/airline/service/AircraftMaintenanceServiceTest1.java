...
class AircraftMaintenanceServiceTest1 {
    ...
    @Test
    @DisplayName("Verify aircraft maintenance logging and due date calculation - Suite 1")
    void testLogMaintenanceSuite1() {
        ...
        MaintenanceRecord rec = MaintenanceRecord.builder()
            ...
            .description("Routine 250 Flight Hours Inspection 1")
        ...
        var response = maintenanceService.logMaintenance(1L, "A_CHECK", "Routine Inspection 1", "Tech 1", BigDecimal.valueOf(15000.00));
