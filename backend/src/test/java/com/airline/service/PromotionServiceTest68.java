...
class PromotionServiceTest68 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 68")
    void testValidatePercentageCoupon68() {
        Promotion promo = Promotion.builder()
            .id((long) 68)
            .couponCode("SKYNOVA68")
            .description("Special Promo 68")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA68")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA68", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
