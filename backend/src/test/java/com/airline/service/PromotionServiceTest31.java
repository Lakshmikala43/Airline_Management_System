...
class PromotionServiceTest31 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 31")
    void testValidatePercentageCoupon31() {
        Promotion promo = Promotion.builder()
            .id((long) 31)
            .couponCode("SKYNOVA31")
            .description("Special Promo 31")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA31")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA31", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
