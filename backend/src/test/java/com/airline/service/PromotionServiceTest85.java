...
class PromotionServiceTest85 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 85")
    void testValidatePercentageCoupon85() {
        Promotion promo = Promotion.builder()
            .id((long) 85)
            .couponCode("SKYNOVA85")
            .description("Special Promo 85")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA85")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA85", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
