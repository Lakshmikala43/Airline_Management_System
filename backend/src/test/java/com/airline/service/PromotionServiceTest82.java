...
class PromotionServiceTest82 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 82")
    void testValidatePercentageCoupon82() {
        Promotion promo = Promotion.builder()
            .id((long) 82)
            .couponCode("SKYNOVA82")
            .description("Special Promo 82")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA82")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA82", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
