...
class PromotionServiceTest83 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 83")
    void testValidatePercentageCoupon83() {
        Promotion promo = Promotion.builder()
            .id((long) 83)
            .couponCode("SKYNOVA83")
            .description("Special Promo 83")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA83")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA83", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
