...
class PromotionServiceTest59 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 59")
    void testValidatePercentageCoupon59() {
        Promotion promo = Promotion.builder()
            .id((long) 59)
            .couponCode("SKYNOVA59")
            .description("Special Promo 59")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA59")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA59", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
