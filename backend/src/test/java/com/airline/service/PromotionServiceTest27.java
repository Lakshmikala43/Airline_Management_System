...
class PromotionServiceTest27 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 27")
    void testValidatePercentageCoupon27() {
        Promotion promo = Promotion.builder()
            .id((long) 27)
            .couponCode("SKYNOVA27")
            .description("Special Promo 27")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA27")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA27", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
