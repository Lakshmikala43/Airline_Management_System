...
class WeatherDelaySimulationServiceTest19 {
    ...
    @Test
    @DisplayName("Verify airport weather forecast and delay risk evaluation - Suite 19")
    void testGetWeatherReportSuite19() {
