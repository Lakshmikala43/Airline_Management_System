...
class PromotionServiceTest73 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 73")
    void testValidatePercentageCoupon73() {
        Promotion promo = Promotion.builder()
            .id((long) 73)
            .couponCode("SKYNOVA73")
            .description("Special Promo 73")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA73")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA73", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
