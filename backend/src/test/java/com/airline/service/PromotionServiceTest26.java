...
class PromotionServiceTest26 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 26")
    void testValidatePercentageCoupon26() {
        Promotion promo = Promotion.builder()
            .id((long) 26)
            .couponCode("SKYNOVA26")
            .description("Special Promo 26")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA26")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA26", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
