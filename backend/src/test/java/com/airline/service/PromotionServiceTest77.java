...
class PromotionServiceTest77 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 77")
    void testValidatePercentageCoupon77() {
        Promotion promo = Promotion.builder()
            .id((long) 77)
            .couponCode("SKYNOVA77")
            .description("Special Promo 77")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA77")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA77", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
