...
class PromotionServiceTest29 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 29")
    void testValidatePercentageCoupon29() {
        Promotion promo = Promotion.builder()
            .id((long) 29)
            .couponCode("SKYNOVA29")
            .description("Special Promo 29")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA29")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA29", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
