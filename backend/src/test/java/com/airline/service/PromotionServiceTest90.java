...
class PromotionServiceTest90 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 90")
    void testValidatePercentageCoupon90() {
        Promotion promo = Promotion.builder()
            .id((long) 90)
            .couponCode("SKYNOVA90")
            .description("Special Promo 90")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA90")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA90", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
