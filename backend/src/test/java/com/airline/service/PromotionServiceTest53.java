...
class PromotionServiceTest53 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 53")
    void testValidatePercentageCoupon53() {
        Promotion promo = Promotion.builder()
            .id((long) 53)
            .couponCode("SKYNOVA53")
            .description("Special Promo 53")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA53")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA53", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
