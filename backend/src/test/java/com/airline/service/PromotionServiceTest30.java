...
class PromotionServiceTest30 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 30")
    void testValidatePercentageCoupon30() {
        Promotion promo = Promotion.builder()
            .id((long) 30)
            .couponCode("SKYNOVA30")
            .description("Special Promo 30")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA30")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA30", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
