...
class PromotionServiceTest23 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 23")
    void testValidatePercentageCoupon23() {
        Promotion promo = Promotion.builder()
            .id((long) 23)
            .couponCode("SKYNOVA23")
            .description("Special Promo 23")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA23")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA23", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
