...
class CurrencyExchangeServiceTest1 {
    ...
    @Test
    @DisplayName("Verify USD to EUR conversion calculation - Suite 1")
    void testUsdToEurConversion1() {
    ...
    @Test
    @DisplayName("Verify USD to INR conversion calculation - Suite 1")
    void testUsdToInrConversion1() {
