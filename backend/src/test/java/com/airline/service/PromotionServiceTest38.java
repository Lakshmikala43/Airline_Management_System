...
class PromotionServiceTest38 {
    ...
    @Test
    @DisplayName("Verify coupon code validation for percentage discounts - Suite 38")
    void testValidatePercentageCoupon38() {
        Promotion promo = Promotion.builder()
            .id((long) 38)
            .couponCode("SKYNOVA38")
            .description("Special Promo 38")
        ...
        when(promotionRepository.findByCouponCode("SKYNOVA38")).thenReturn(Optional.of(promo));

        var resp = promotionService.validateCoupon("SKYNOVA38", BigDecimal.valueOf(500.00));
        assertNotNull(resp);
