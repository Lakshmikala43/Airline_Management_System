...
class ValidationSuiteTest21 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 21")
    void testPassportValidation21() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 21")
    void testScheduleValidation21() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 21")
    void testSeatMatrixValidation21() {
