...
class ValidationSuiteTest6 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 6")
    void testPassportValidation6() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 6")
    void testScheduleValidation6() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 6")
    void testSeatMatrixValidation6() {
