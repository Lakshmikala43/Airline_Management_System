...
class ValidationSuiteTest90 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 90")
    void testPassportValidation90() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 90")
    void testScheduleValidation90() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 90")
    void testSeatMatrixValidation90() {
