...
class ValidationSuiteTest2 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 2")
    void testPassportValidation2() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 2")
    void testScheduleValidation2() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 2")
    void testSeatMatrixValidation2() {
