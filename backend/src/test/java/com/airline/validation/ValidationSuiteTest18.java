...
class ValidationSuiteTest18 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 18")
    void testPassportValidation18() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 18")
    void testScheduleValidation18() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 18")
    void testSeatMatrixValidation18() {
