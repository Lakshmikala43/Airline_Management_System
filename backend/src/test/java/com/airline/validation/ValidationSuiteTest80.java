...
class ValidationSuiteTest80 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 80")
    void testPassportValidation80() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 80")
    void testScheduleValidation80() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 80")
    void testSeatMatrixValidation80() {
