...
class ValidationSuiteTest60 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 60")
    void testPassportValidation60() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 60")
    void testScheduleValidation60() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 60")
    void testSeatMatrixValidation60() {
