...
class ValidationSuiteTest30 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 30")
    void testPassportValidation30() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 30")
    void testScheduleValidation30() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 30")
    void testSeatMatrixValidation30() {
