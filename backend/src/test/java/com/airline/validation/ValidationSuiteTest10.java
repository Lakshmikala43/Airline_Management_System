...
class ValidationSuiteTest10 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 10")
    void testPassportValidation10() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 10")
    void testScheduleValidation10() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 10")
    void testSeatMatrixValidation10() {
