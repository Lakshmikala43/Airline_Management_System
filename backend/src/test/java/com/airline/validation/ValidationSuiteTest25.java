...
class ValidationSuiteTest25 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 25")
    void testPassportValidation25() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 25")
    void testScheduleValidation25() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 25")
    void testSeatMatrixValidation25() {
