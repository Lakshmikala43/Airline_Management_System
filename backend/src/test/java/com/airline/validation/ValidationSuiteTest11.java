...
class ValidationSuiteTest11 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 11")
    void testPassportValidation11() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 11")
    void testScheduleValidation11() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 11")
    void testSeatMatrixValidation11() {
