...
class ValidationSuiteTest4 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 4")
    void testPassportValidation4() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 4")
    void testScheduleValidation4() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 4")
    void testSeatMatrixValidation4() {
