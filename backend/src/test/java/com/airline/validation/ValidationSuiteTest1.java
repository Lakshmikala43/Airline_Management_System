...
class ValidationSuiteTest1 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 1")
    void testPassportValidation1() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 1")
    void testScheduleValidation1() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 1")
    void testSeatMatrixValidation1() {
