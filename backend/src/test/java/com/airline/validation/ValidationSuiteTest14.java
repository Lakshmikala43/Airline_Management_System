...
class ValidationSuiteTest14 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 14")
    void testPassportValidation14() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 14")
    void testScheduleValidation14() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 14")
    void testSeatMatrixValidation14() {
