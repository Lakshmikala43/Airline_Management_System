...
class ValidationSuiteTest5 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 5")
    void testPassportValidation5() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 5")
    void testScheduleValidation5() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 5")
    void testSeatMatrixValidation5() {
