...
class ValidationSuiteTest8 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 8")
    void testPassportValidation8() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 8")
    void testScheduleValidation8() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 8")
    void testSeatMatrixValidation8() {
