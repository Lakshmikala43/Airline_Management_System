...
class ValidationSuiteTest3 {
    ...
    @Test
    @DisplayName("Verify passport validation logic - Suite 3")
    void testPassportValidation3() {
    ...
    @Test
    @DisplayName("Verify flight schedule time boundary validation - Suite 3")
    void testScheduleValidation3() {
    ...
    @Test
    @DisplayName("Verify seat matrix selection boundaries - Suite 3")
    void testSeatMatrixValidation3() {
