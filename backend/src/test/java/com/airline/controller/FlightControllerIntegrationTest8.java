...
class FlightControllerIntegrationTest8 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 8")
    void testSearchFlightsEndpoint8() {
        ...
        assertEquals("SN-208", response.getBody().get(0).getFlightNumber());
    }
}
