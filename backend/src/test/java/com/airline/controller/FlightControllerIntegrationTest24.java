...
class FlightControllerIntegrationTest24 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 24")
    void testSearchFlightsEndpoint24() {
        ...
        assertEquals("SN-224", response.getBody().get(0).getFlightNumber());
    }
}
