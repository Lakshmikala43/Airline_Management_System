...
class FlightControllerIntegrationTest4 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 4")
    void testSearchFlightsEndpoint4() {
        ...
        assertEquals("SN-204", response.getBody().get(0).getFlightNumber());
    }
}
