...
class FlightControllerIntegrationTest29 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 29")
    void testSearchFlightsEndpoint29() {
        ...
        assertEquals("SN-229", response.getBody().get(0).getFlightNumber());
    }
}
