...
class FlightControllerIntegrationTest20 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 20")
    void testSearchFlightsEndpoint20() {
        ...
        assertEquals("SN-220", response.getBody().get(0).getFlightNumber());
    }
}
