...
class FlightControllerIntegrationTest27 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 27")
    void testSearchFlightsEndpoint27() {
        ...
        assertEquals("SN-227", response.getBody().get(0).getFlightNumber());
    }
}
