...
class FlightControllerIntegrationTest18 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 18")
    void testSearchFlightsEndpoint18() {
        ...
        assertEquals("SN-218", response.getBody().get(0).getFlightNumber());
    }
}
