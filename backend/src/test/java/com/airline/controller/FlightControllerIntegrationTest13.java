...
class FlightControllerIntegrationTest13 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 13")
    void testSearchFlightsEndpoint13() {
        ...
        assertEquals("SN-213", response.getBody().get(0).getFlightNumber());
    }
}
