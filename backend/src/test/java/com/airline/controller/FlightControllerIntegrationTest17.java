...
class FlightControllerIntegrationTest17 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 17")
    void testSearchFlightsEndpoint17() {
        ...
        assertEquals("SN-217", response.getBody().get(0).getFlightNumber());
    }
}
