...
class FlightControllerIntegrationTest30 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 30")
    void testSearchFlightsEndpoint30() {
        ...
        assertEquals("SN-230", response.getBody().get(0).getFlightNumber());
    }
}
