...
class FlightControllerIntegrationTest19 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 19")
    void testSearchFlightsEndpoint19() {
        ...
        assertEquals("SN-219", response.getBody().get(0).getFlightNumber());
    }
}
