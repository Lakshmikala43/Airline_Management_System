...
class FlightControllerIntegrationTest26 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 26")
    void testSearchFlightsEndpoint26() {
        ...
        assertEquals("SN-226", response.getBody().get(0).getFlightNumber());
    }
}
