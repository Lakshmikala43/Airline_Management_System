...
class FlightControllerIntegrationTest21 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 21")
    void testSearchFlightsEndpoint21() {
        ...
        assertEquals("SN-221", response.getBody().get(0).getFlightNumber());
    }
}
