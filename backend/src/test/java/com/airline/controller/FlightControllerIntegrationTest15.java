...
class FlightControllerIntegrationTest15 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 15")
    void testSearchFlightsEndpoint15() {
        ...
        assertEquals("SN-215", response.getBody().get(0).getFlightNumber());
    }
}
