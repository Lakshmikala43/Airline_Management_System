...
class FlightControllerIntegrationTest22 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 22")
    void testSearchFlightsEndpoint22() {
        ...
        assertEquals("SN-222", response.getBody().get(0).getFlightNumber());
    }
}
