...
class FlightControllerIntegrationTest3 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 3")
    void testSearchFlightsEndpoint3() {
        ...
        assertEquals("SN-203", response.getBody().get(0).getFlightNumber());
    }
}
