...
class FlightControllerIntegrationTest16 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 16")
    void testSearchFlightsEndpoint16() {
        ...
        assertEquals("SN-216", response.getBody().get(0).getFlightNumber());
    }
}
