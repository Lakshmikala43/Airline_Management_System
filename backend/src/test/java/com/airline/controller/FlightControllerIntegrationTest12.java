...
class FlightControllerIntegrationTest12 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 12")
    void testSearchFlightsEndpoint12() {
        ...
        assertEquals("SN-212", response.getBody().get(0).getFlightNumber());
    }
}
