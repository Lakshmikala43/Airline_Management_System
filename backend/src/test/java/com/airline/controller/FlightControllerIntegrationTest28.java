...
class FlightControllerIntegrationTest28 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 28")
    void testSearchFlightsEndpoint28() {
        ...
        assertEquals("SN-228", response.getBody().get(0).getFlightNumber());
    }
}
