...
class FlightControllerIntegrationTest23 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 23")
    void testSearchFlightsEndpoint23() {
        ...
        assertEquals("SN-223", response.getBody().get(0).getFlightNumber());
    }
}
