...
class FlightControllerIntegrationTest25 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 25")
    void testSearchFlightsEndpoint25() {
        ...
        assertEquals("SN-225", response.getBody().get(0).getFlightNumber());
    }
}
