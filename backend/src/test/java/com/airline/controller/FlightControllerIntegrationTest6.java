...
class FlightControllerIntegrationTest6 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 6")
    void testSearchFlightsEndpoint6() {
        ...
        assertEquals("SN-206", response.getBody().get(0).getFlightNumber());
    }
}
