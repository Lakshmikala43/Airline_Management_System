...
class FlightControllerIntegrationTest2 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 2")
    void testSearchFlightsEndpoint2() {
        ...
        assertEquals("SN-202", response.getBody().get(0).getFlightNumber());
    }
}
