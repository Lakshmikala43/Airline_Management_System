...
class FlightControllerIntegrationTest14 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 14")
    void testSearchFlightsEndpoint14() {
        ...
        assertEquals("SN-214", response.getBody().get(0).getFlightNumber());
    }
}
