...
class FlightControllerIntegrationTest11 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 11")
    void testSearchFlightsEndpoint11() {
        ...
        assertEquals("SN-211", response.getBody().get(0).getFlightNumber());
    }
}
