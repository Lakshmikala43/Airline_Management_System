...
class FlightControllerIntegrationTest10 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 10")
    void testSearchFlightsEndpoint10() {
        ...
        assertEquals("SN-210", response.getBody().get(0).getFlightNumber());
    }
}
