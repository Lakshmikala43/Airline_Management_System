...
class FlightControllerIntegrationTest5 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 5")
    void testSearchFlightsEndpoint5() {
        ...
        assertEquals("SN-205", response.getBody().get(0).getFlightNumber());
    }
}
