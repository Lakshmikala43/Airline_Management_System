...
class FlightControllerIntegrationTest9 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 9")
    void testSearchFlightsEndpoint9() {
        ...
        assertEquals("SN-209", response.getBody().get(0).getFlightNumber());
    }
}
