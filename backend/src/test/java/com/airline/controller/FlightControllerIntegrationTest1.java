...
class FlightControllerIntegrationTest1 {
    ...
    @Test
    @DisplayName("Verify search flights endpoint response - Integration Suite 1")
    void testSearchFlightsEndpoint1() {
        ...
        assertEquals("SN-201", response.getBody().get(0).getFlightNumber());
    }
}
